...
<p>Your puzzle answer was <code>10228230</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>The galaxies are much <em>older</em> (and thus much <em>farther apart</em>) than the researcher initially estimated.</p>
...
<p>Your puzzle answer was <code>447073334102</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>
