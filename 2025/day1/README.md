...
<p>Your puzzle answer was <code>1118</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>You're sure that's the right password, but the door won't open. You knock, but nobody answers. You build a snowman while you think.</p>
...
<p>Your puzzle answer was <code>6289</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>
